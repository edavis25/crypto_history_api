...
class CryptocompareMeasurementCollection extends ResourceCollection
{
    ...
    /**
     * CryptocompareMeasurementCollection constructor.
     *
     * @param $resource
    ...
    {
        return [
            'data' => CryptocompareMeasurement::collection($this->collection),
            'links' => [
